...
CREATE TABLE `payments` (
  ...
  `paymentdescr` varchar(255) NOT NULL
...
ALTER TABLE `customers`
  ...
  ALTER TABLE `customers` 
  CHANGE `custom_email` `custom_email` VARCHAR(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL;
--
...
ALTER TABLE `invoice_items`
  ...
  ALTER TABLE `invoice_items` CHANGE `Units` `Units` VARCHAR(40) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL;
--
...
ALTER TABLE `store_customers` 
  CHANGE `company_contact` `company_contact` VARCHAR(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL;
...
--
-- Table structure for table `inv_system`
--
...
--
-- Dumping data for table `inv_system`
--

INSERT INTO `inv_system` (`db_version`, `app_version`) VALUES
('1.001', '1.001');
