	...
	*******************************************************************************/
	function Header()
	{
		...
		if($this->PageNo()==1) 
		{
			...
			$this->Cell($width+30,$lineheight,strtoupper($this->l['to']),0,0,'L');
	...
	{	
		...
		if($this->items) {
		  ...
		  $this->SetTextColor($this->color[0],$this->color[1],$this->color[2]);
		  $this->Cell(2,$lineheight,iconv("UTF-8", "ISO-8859-1",strtoupper($item['description']).':'),0,0,'L');
		  $this->SetTextColor(50,50,50);
		  $this->SetFont($this->font,'',9);
		  $this->SetXY (2,50);
		  $this->Cell(0,$lineheight,$item['description'],0,1,'L');
		  $this->SetXY (2,28);
		  $this->Cell(4,$lineheight,$item['item'],0,1,'L');
          $this->SetXY (2,31);
		  $this->Cell(8,$lineheight,$item['vat'],0,1,'L');

		  $this->Cell(12,$lineheight,$item['discount'],0,1,'L');

		  $this->Cell(12,$lineheight,$item['total'],0,1,'L');
			...
			//	$this->SetTextColor(50,50,50);
				...
				$this->Cell(20,$cHeight,'',0,0,'L',1);  // dasnz
				$x = $this->GetX();
