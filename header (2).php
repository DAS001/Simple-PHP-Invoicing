...
<div class="wrapper">
 ...
 <!--       <li class="treeview">
          <a href="#"><i class="fa fa-users"></i><span>Payments</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="payment-add.php"><i class="fa fa-user-plus"></i>Add Payment</a></li>
            <li><a href="payment-list.php"><i class="fa fa-cog"></i>Manage Payments</a></li>
          </ul>
        </li> -->
