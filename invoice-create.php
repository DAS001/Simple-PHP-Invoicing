...
?>
		...
		<form method="post" id="create_invoice" name="">
				        ...
				        <div class="form-group">
				            <div class="input-group date" id="invoice_date">
				                ...
				                <span class="input-group-addon">
				                    <span class="glyphicon glyphicon-calendar" alt="Display Calendar" title="Display Calendar"></span>
				                </span>
				            </div>
				        </div>
				    </div>
				    <div class="col-xs-4">
				        <div class="form-group">
				            <div class="input-group date" id="invoice_due_date">
				                ...
				                <span class="input-group-addon">
				                    <span alt="Display Calendar" title="Display Calendar" class="glyphicon glyphicon-calendar" ></span>
				                </span>
				            </div>
				        </div>
				    </div>
			...
			<table class="table table-bordered table-hover table-striped" id="invoice_table" style="position: relative; height: 20px;">
				<thead>
					<tr style="height: 20px;">
						<th>
							<h5><a href="#" class="btn btn-success btn-xs add-row"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a> Item No/Product Description</h5>
						</th>
						<th>
							<h5>Qty</h5>
						</th>
				...
				<tbody>
					<tr style='height: 15px; width: 1200px;'>
						<td width="490px" style="height: 30px;">
							<div class="form-group form-group-sm  no-margin-bottom">
								<a href="#" class="btn btn-danger btn-xs delete-row"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
								<input type="text" class="form-control invoice_product_item_no text-left" name="invoice_product_item_no[]" value="1" style="width: 37px; border: none; color: #000000";>
                                <input type="text" name="invoice_product_save[]" class="invoice_product_save" style="width: 350px; position: relative; left: 58px; top: -30px;">
								<input type="hidden" class="form-control form-group-sm item-input item_select_prod calculate calculate_amt add_row invoice_product" name="invoice_product[]" style="position: relative; top: -38px; left: 48px; opacity: .30; color: #000000" placeholder="Enter Product Name OR Description">
								<div class="item-select" style="position: relative; top: -34px; left: 30px;">or <a href="#">select a product </a></i></div>
							</div>
						</td>
						...
						<td class="text-right">
							<div class="input-group input-group-sm  no-margin-bottom">
								...
								<input type="number" class="form-control calculate calculate_amt invoice_product_price required" style="width: 100px;" name="invoice_product_price[]" aria-describedby="sizing-addon1" placeholder="0.00">
							</div>
						</td>
						<td class="text-right" width="210px">
							<div class="form-group form-group-sm  no-margin-bottom">
								<input type="text" class="form-control calculate calculate_amt" style='width: 210px;' name="invoice_product_discount[]" placeholder="Enter % OR value (ex: 10% or 10.50)">
							</div>
						</td>
						<td class="text-right" width="120px">
							<div class="form-group form-group-sm  no-margin-bottom">
								<input type="text" class="form-control calculate calculate_amt" name="invoice_product_discount_amt[]" readonly placeholder="Discount Amt"> 
							</div>
						</td>
						<td class="text-right" width="120px">
							<div class="input-group input-group-sm">
								<span class="input-group-addon"><?php echo CURRENCY ?></span>
								<input type="text" class="form-control calculate calculate-sub" name="invoice_product_sub[]" id="invoice_product_sub" value="0.00" aria-describedby="sizing-addon1" readonly>
							</div>
						</td>
					</tr>
				</tbody>
			...
			<div id="invoice_totals" class="padding-right row text-right">
				...
				<div class="col-xs-6 no-padding-right">
					<div class="row">
						...
						<div class="col-xs-3">
							<?php echo CURRENCY ?><span class="invoice-full-total">0.00</span>
							<input type="hidden" name="invoice_fulltotal" id="invoice_fulltotal">
						</div>
					</div>
					<div class="row">
						<div class="col-xs-4 col-xs-offset-5">
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<div class="input-group input-group-sm">
								<span class="input-group-addon"><?php echo CURRENCY ?></span>
								<input type="text" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.42857143; color: #333; position:relative; left: 12px;" class="form-control calculate calculate_amt shipping" id="invoice_shipping" name="invoice_shipping" aria-describedby="sizing-addon1" placeholder="0.00" value="0.00">
							</div>
						</div>
					</div>
					...
					<div class="col-xs-6">
						<input type="hidden" name="custom_email" id="custom_email" class="custom_email_textarea" placeholder="Enter custom email if you wish to override the default invoice type email msg!"></input>
					</div>
