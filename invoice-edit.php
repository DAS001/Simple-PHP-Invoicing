		...
		<form method="post" id="update_invoice">
			...
			<table class="table table-bordered" id="invoice_table">
				<thead>
					<tr>
						<th width="500">
							<h4><a href="#" class="btn btn-success btn-xs add-row"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a> Item No/Product Description</h4>
						</th>
						<th>
							<h4>Qty</h4>
						</th>
				...
				<tbody>
					<?php 
						...
						// the query
						$query2 = "SELECT * FROM invoice_items WHERE invoice = '" . $mysqli->real_escape_string($getID) . "' ORDER BY item_no ASC";
					...
					<tr height="20px">
						<td width="420px">
							<div class="form-group form-group-sm  no-margin-bottom">
								...
								<input type="text" class="form-control invoice_product_item_no" name="invoice_product_item_no[]"  value="<?php echo $item_no; ?>" style="width: 25px; border: none; color: #000000";>

								<input type="text" class="form-control form-group-sm item-input invoice_product" style="position: relative; top: -28px; left: 45px; width: 270px;" name="invoice_product[]" placeholder="Enter item title and / or description" value="<?php echo $item_product; ?>">
								
								<div class="item-select" style="position: relative; top: -28px; left: 48px;">or <a href="#">select an item</a></>
							</div>
						</td>
						<td class="text-right">
							<div class="form-group form-group-sm no-margin-bottom">
						...
						<td class="text-right" width="90px">
							<div class="input-group input-group-sm  no-margin-bottom">
								...
								<input type="text" class="form-control calculate invoice_product_price required" style="width: 80px;" name="invoice_product_price[]" aria-describedby="sizing-addon1" placeholder="0.00" value="<?php echo $item_price; ?>">
							</div>
						</td>
						<td class="text-right" width="220px">
							<div class="form-group form-group-sm  no-margin-bottom">
								<input type="text" class="form-control calculate" name="invoice_product_discount[]" style="width: 250px;" placeholder="Enter % or value (ex: 10% or 10.50)" value="<?php echo $item_discount; ?>">
							</div>
						</td>
						<td class="text-right" width="150px">
							<div class="form-group form-group-sm  no-margin-bottom">
								<input type="text" class="form-control calculate calculate_amt" name="invoice_product_discount_amt[]" readonly placeholder="Discount Amount"> 
							</div>
						</td>
				...
				<div class="row">
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<div class="input-group input-group-sm">
								<span class="input-group-addon"><?php echo CURRENCY ?></span>
								<input type="text" class="form-control calculate shipping" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.42857143; color: #333; position:relative; left: 12px;" name="invoice_shipping" aria-describedby="sizing-addon1" placeholder="0.00" value="<?php echo $invoice_shipping; ?>">
							</div>
						</div>
					</div>
