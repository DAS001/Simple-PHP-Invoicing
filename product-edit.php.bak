...
if($result) {
	while ($row = mysqli_fetch_assoc($result)) {
		...
		$product_code = $row['product_code']; // product price
	}
}
		...
		<div class="panel panel-default">
			...
			<div class="panel-body form-group form-group-sm">
				<form method="post" id="update_product">
					...
					<div class="row">
				  	   <div class="col-xs-4">
							<input type="text" class="form-control required" name="product_code" placeholder="Enter product code" value="<?php echo $product_code; ?>">
						</div>
						<div class="col-xs-4">
